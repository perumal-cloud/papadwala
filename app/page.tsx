    ...
    >
      ...
      <div className="min-h-screen bg-white/90 backdrop-blur-sm">
        ...
        <section
          ...
          style={{
            backgroundImage: "url('/images/news-letter.jpg')",
          }}
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="flex items-center space-x-3 ">
                <div className="flex-shrink-0">
                  <svg className="h-8 w-8 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18 18.5a1.5 1.5 0 01-1.5-1.5 1.5 1.5 0 011.5-1.5 1.5 1.5 0 011.5 1.5 1.5 1.5 0 01-1.5 1.5m1.5-9l1.96 2.5L17 13.5m-11 5a1.5 1.5 0 01-1.5-1.5A1.5 1.5 0 016 15.5 1.5 1.5 0 017.5 17 1.5 1.5 0 016 18.5M20 8h-3V4H3c-1.11 0-2 .89-2 2v11h2a3 3 0 003 3 3 3 0 003-3h6a3 3 0 003 3 3 3 0 003-3h2v-5l-3-4z" />
                  </svg>
                </div>
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    <Link href="/help" className="underline cursor-pointer hover:text-gray-700">₹50 for orders below ₹500</Link>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    <Link href="/terms#returns" className="underline cursor-pointer hover:text-gray-700">Find out more</Link>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    <Link href="/terms#secure-shopping" className="underline cursor-pointer hover:text-gray-700">Find out more</Link>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    <Link href="/help" className="underline cursor-pointer hover:text-gray-700">100% Fresh & Natural</Link>
                  </p>
                </div>
              </div>
            </div>
