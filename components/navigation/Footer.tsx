      ...
      <div className="max-w-8xl mx-20 px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">PapadShop</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-800">info@papadshop.com</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <svg className="h-6 w-6 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-8 pt-8 border-t border-gray-300 text-center">
          <p className="text-gray-600">
            © {new Date().getFullYear()} PapadShop. All rights reserved. Made with ❤️ for papad lovers.
          </p>
        </div>
      </div>
    </footer>
